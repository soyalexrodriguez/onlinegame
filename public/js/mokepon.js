...
function unirseAlJuego() {
    fetch("http://192.168.1.22:8080/unirse")
    .then((res) => {
        if (res.ok) {
            res.text()
            .then((respuesta) => {
...
function selecionarMokepon(mascotaJugador) {
    fetch(`http://192.168.1.22:8080/mokepon/${jugadorId}`, {
        method: "post",
        headers: {
...
function enviarAtaques() {
    fetch(`http://192.168.1.22:8080/mokepon/${jugadorId}/ataques`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
...
function obtenerAtaques() {
    fetch(`http://192.168.1.22:8080/mokepon/${enemigoId}/ataques`)
    .then(function (res) {
        if (res.ok) {
            res.json()
...
function revisarVidas() {
    if (victoriasJugador === victoriasEnemigo) {
        ...
        //PERDIMOS
        crearMensajeFinal("Lo siento You lose 😢")
    }
}
...
function enviarPosicion(x, y) {
    fetch(`http://192.168.1.22:8080/mokepon/${jugadorId}/posicion`, {
        method: "post",
        headers: {
            "Content-Type":"application/json"
        },
